<div class="mb-16">
    <div class="flex flex-col md:flex-row  bg-neutral-primary-soft p-6 border border-default rounded-base shadow-xs ">
        <img class="object-cover  rounded-base h-64 md:h-auto md:w-48 mb-4 md:mb-0"
        ...
        <div class="w-full flex flex-col justify-between md:p-4 leading-normal ml-5">
            ...
            <div>
                <x-primary-button class="mb-4">
                    <a
                        href="{{ route('post.show', ['username' => $post->user->username, 'post' => $post->slug]) }}">{{ __('messages.rm') }}</a>
